...
def perform_readout_noise_test(cam_id):
    ...
    try:
        # Step 1: Capture 100 bias frames
        num_initial_bias_frames = 100
        bias_frames = capture_bias_frames(cam_handle, cam_id, num_initial_bias_frames)
        ...
        # Step 3: Capture 545 additional bias frames
        del bias_frames  # Free up memory by deleting the initial bias frames
        num_additional_bias_frames = 100
        additional_bias_frames = capture_bias_frames(cam_handle, cam_id, num_additional_bias_frames)
...
def pnp_in(cam_id):
    ...
    perform_readout_noise_test(cam_id)
